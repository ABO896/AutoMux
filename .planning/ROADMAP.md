...
**Plans**: 8 plans (6/6 executed; 2 gap-closure plans from 09-UAT.md pending)
Plans:
**Wave 1**
...
- [ ] 09-07-PLAN.md — macOS observer fixes: narrow the CGEventTap event mask to consumed types (G-09-1a perf tax) + instrument & harden the NSWorkspace active-app observer, reading the activated bundle id from the notification userInfo (G-09-1c targeting) (EXEC-01, EXEC-02)
...
| 9. Parallel Macro Execution | v2.0 | 6/6 | In Progress|  |
