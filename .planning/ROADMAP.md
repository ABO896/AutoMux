...
- [ ] 09-01-PLAN.md — Scheduler parallel-execution tests + action_tx capacity 1024 + debug-only drop counter & IPC (EXEC-01, EXEC-02)
...
| 9. Parallel Macro Execution | v2.0 | 0/3 | Not started | — |
